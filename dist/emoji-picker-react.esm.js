...
function clsx() {
  ...
  var classes = args.reduce(function (classes, arg) {
    if (typeof arg === 'string') {
      classes.push(arg);
    }

    if (Array.isArray(arg)) {
      classes.push(clsx.apply(void 0, arg));
    }
...
function useOnEmojiClickConfig() {
  ...
  return current.onEmojiClick || function () {};
}
...
function CategoryNavigation() {
  ...
  return createElement("div", {
    ...
    return createElement(Button, {
      ...
      className: clsx('epr-cat-btn', "epr-icn-" + category, (_clsx = {}, _clsx[ClassNames.active] = isActiveCategory, _clsx)),
      key: category,
      onClick: function onClick() {
...
function Search() {
  ...
  return createElement(Relative, {
    ...
    id: "epr-search-id",
    "aria-atomic": "true"
  }, statusSearchResults) : null, createElement("div", {
...
function PickerRootElement(_ref2) {
  ...
  return createElement("aside", {
    className: clsx(ClassNames.emojiPicker, 'epr-main', (_clsx = {}, _clsx[ClassNames.searchActive] = searchModeActive, _clsx[ClassNames.darkTheme] = theme === Theme.DARK, _clsx[ClassNames.autoTheme] = theme === Theme.AUTO, _clsx), className),
    ref: PickerMainRef,
    style: style
  }, children);
}
...
var EmojiPickerReact = /*#__PURE__*/memo(EmojiPicker, function (prev, next) {
